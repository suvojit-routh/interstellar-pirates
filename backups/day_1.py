...
class Upgrade():
    def __init__(self,screen,data,image):
        ...
        self.thruster_slot = pygame.Rect((self.pos_x,self.pipe_two.y+100),(200,150))
        self.cannon_slot = pygame.Rect((self.pos_x,self.pipe_one.y-150),(200,150))
        ...
        self.plasma_cannon_rect = self.plasma_cannon_image.get_rect(topleft = (self.cannon_slot.x + (200-100)//2,self.cannon_slot.y + (150-100)//2))
        self.laser_beam_image = pygame.transform.scale(pygame.image.load("graphics/upgrades/laser_beam.jpeg"),(100,100)).convert_alpha()
        self.laser_beam_rect = self.laser_beam_image.get_rect(topleft = (self.cannon_slot.x + (200-100)//2,self.cannon_slot.y + (150-100)//2))
    def draw(self):
        self.clicks()
    ...
    def draw_plasma_cannon(self):
        if self.data["spaceship"] == 0 and self.data["defaultship_equipment"]["plasma_cannon"] == True:
            self.screen.blit(self.plasma_cannon_image,(self.cannon_slot.x + (200-100)//2,self.cannon_slot.y + (150-100)//2))
    ...
    def draw_laser_beam(self):
        if self.data["spaceship"] == 0 and self.data["defaultship_equipment"]["laser_beam"] == True:
            self.screen.blit(self.laser_beam_image,(self.cannon_slot.x + (200-100)//2,self.cannon_slot.y + (150-100)//2))
...
class Bullets(pygame.sprite.Sprite):
    def __init__(self, pos_x, pos_y):
        super().__init__()
        # self.image = pygame.Surface((8,40)).convert_alpha()
        # self.image.fill("red")
