...
file_path = os.path.join(roaming_path, "data.json")
...
#BGM
menu_music = pygame.mixer.Sound('Sound/BGM/Cosmic Flight.mp3')
...
exhaust_button = Rect_Button(screen,200,60,50,450,'Exhaust','yellow','red','black')
upgrades_button = Rect_Button(screen,200,60,50,350,"Upgrade",'yellow','red','black')
...
class Upgrade:
    def __init__(self, screen, data, image):
        ...
        self.upgrades = {
            "plasma_cannon": {
                "image": pygame.transform.scale(pygame.image.load("graphics/upgrades/plasma_cannon.jpeg"), (100, 100)).convert_alpha(),
                "rect": self.cannon_slot,
            },
            "laser_beam": {
                "image": pygame.transform.scale(pygame.image.load("graphics/upgrades/laser_beam.jpeg"), (100, 100)).convert_alpha(),
                "rect": self.cannon_slot,
            },
            "launch_thruster" : {
            "image": pygame.transform.scale(pygame.image.load("graphics/upgrades/launch_thruster.jpeg"), (100, 100)).convert_alpha(),
...
def upgrade_menu(spaceship):
    ...
    img = pygame.transform.scale(pygame.image.load(ship_images[spaceship]), (200, 200)).convert_alpha()
...
def select_thruster():
    ...
    draw_thruster_option("launch_thruster", 550, 100)
def draw_thruster_option(upgrade_name, x, y):
    global game_data, state

    font = pygame.font.Font('font/gacha.ttf', 20)
    gap = 4
    image = pygame.transform.scale(pygame.image.load(f"graphics/upgrades/{upgrade_name}.jpeg"), (100, 100)).convert_alpha()
...
def select_cannon():
    ...
    draw_canno_option("laser_beam", 450, 100)
    draw_canno_option("plasma_cannon", 650, 100)


def draw_canno_option(upgrade_name, x, y):
    global game_data, state
    ...
    if image_rect.collidepoint(pos) and pygame.mouse.get_pressed()[0]:
        if is_equipped:
            ...
            # EQUIP upgrade
            alt_upgrade = "plasma_cannon" if upgrade_name == "laser_beam" else "laser_beam"
            current_equipment[upgrade_name] = True
            game_data['upgrades'][upgrade_name] -= 1

            if current_equipment[alt_upgrade]:
                current_equipment[alt_upgrade] = False
                game_data['upgrades'][alt_upgrade] += 1
...
gacha_prize = {
    "iron": [pygame.transform.scale(pygame.image.load("graphics/gemstone/iron.png"), (200, 200)),"iron"],
    "copper": [pygame.transform.scale(pygame.image.load("graphics/gemstone/copper.png"), (200, 200)),"copper"],
    "silver": [pygame.transform.scale(pygame.image.load("graphics/gemstone/silver.png"), (200, 200)),"silver"],
    "coal": [pygame.transform.scale(pygame.image.load("graphics/gemstone/coal.png"), (200, 200)),"coal"],
    "gold_ore": [pygame.transform.scale(pygame.image.load("graphics/gemstone/gold_ore.png"), (200, 200)),"gold ore"],
    "lavastone": [pygame.transform.scale(pygame.image.load("graphics/gemstone/lavastone.png"), (200, 200)),"lavastone"],
    "platinum": [pygame.transform.scale(pygame.image.load("graphics/gemstone/platinum.png"), (200, 200)),"platinum"],
    "frost crystal": [pygame.transform.scale(pygame.image.load("graphics/gemstone/frost crystal.png"), (200, 200)),"frost crystal"],
    "purple gemstone": [pygame.transform.scale(pygame.image.load("graphics/gemstone/purple gemstone.png"), (200, 200)),"purple gemstone"],
    "emerald": [pygame.transform.scale(pygame.image.load("graphics/gemstone/emerald.png"), (200, 200)),"emerald"],
    "iridium": [pygame.transform.scale(pygame.image.load("graphics/gemstone/iridium.png"), (200, 200)),"iridium"],
    "furryship_owned": [pygame.transform.scale(pygame.image.load("graphics/Spaceship/ship5.png"), (200, 200)),"furry ship"],
    "zenoship_owned": [pygame.transform.scale(pygame.image.load("graphics/Spaceship/ship4.png"), (200, 200)),"zeno ship"],
    "laser_beam" : [pygame.transform.scale(pygame.image.load("graphics/upgrades/laser_beam.jpeg"), (200, 200)),"laser beam"],
    "plasma_cannon" : [pygame.transform.scale(pygame.image.load("graphics/upgrades/plasma_cannon.jpeg"), (200, 200)),"plasma cannon"],
    "launch_thruster" : [pygame.transform.scale(pygame.image.load("graphics/upgrades/launch_thruster.jpeg"), (200, 200)),"launch thruster"]
}
...
class Gacha():
    def __init__(self):
        ...
        self.limited_button = Rect_Button(screen,150,40,25,40,"Limited","white","gold","black",font_size =22)
        self.permanent_button = Rect_Button(screen,150,40,25,140,"Permanent","white","gold","black",font_size =22)
        self.powerups_button = Rect_Button(screen,150,40,25,240,"Powerups","white","gold","black",font_size =22)
    ...
    def menu(self):
        ...
        if game_data["jade"] >= 1000:
            if multi_pull_btn.draw():
                ...
                self.video = cv2.VideoCapture("wish.mp4")
                game_data['jade'] -= 1000
                game_data["dailies"]["wish_completed"] += 10
                self.pull_count = 10
                state = State.GACHA_ROLL
    ...
    def result(self):
        ...
        if self.pull_count == 1:
            ...
            pygame.draw.rect(screen,"black",[img_x,img_y,img.get_width(),img.get_height()],0,6)
            ...
            for idx, (item, amount) in enumerate(self.results):
                ...
                img = gacha_prize[item][0]
                pygame.draw.rect(screen,"black",[x,y,img.get_width(),img.get_height()],0,6)
